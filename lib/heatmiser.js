...
var parse_dcb = function(dcb_buf){
  ...
  return {
    ...
    model: model,
    version: version/10,
    temperature_format: ['C', 'F'][dcb_buf.readUInt8(5)],
    ...
    frost_protect_temperature: dcb_buf.readUInt8(17),
    set_room_temperature: dcb_buf.readUInt8(18),
    ...
    built_in_air_temperature: dcb_buf.readUInt16LE(37) === 0xFFFF ? null : dcb_buf.readUInt16LE(37)/10,
